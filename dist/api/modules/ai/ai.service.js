...
let AiService = class AiService {
    ...
    generateForecast(tenantId, domain) {
        const forecasts = {
            cashflow: {
                domain: "Finance",
                horizon: "90 days",
    ...
    chat(tenantId, messages, context) {
        ...
        if (contextKey && contextResponses[contextKey])
            return contextResponses[contextKey];
        return {
